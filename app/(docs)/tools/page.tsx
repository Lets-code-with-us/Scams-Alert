...
export const metadata: Metadata = {
    title: 'Developer Tools | Free Online Web Development Tools | ScamAlert',
    ...
    alternates: {
        canonical: 'https://ScamAlert.in/tools',
    },
}
